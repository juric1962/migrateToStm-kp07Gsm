...
__flash char versia[] = {"M2560!newboot:Elam 18-05-22ID DevConm2m"};                         //{'S','I','0','2','.','0','6',':','1','1','0','3','1','6'};
...
case 38: 
 ...
 if ( vol_tx_ppp == 0 ) return;   /// заплатка от 23 06 22
 //************************    
         ...
         case 0x2d:   // вниз
           ...
           case 0x0d:   // ввод
                  {  
                   ...
                   if ((vol_tx_ppp==1)||(index_pa==0)) goto pusto; 
        nene_pusto:
