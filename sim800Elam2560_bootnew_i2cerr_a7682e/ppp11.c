...
//23.03.07 попытка адоптации Сименса 35 путем соглашения на все запрашиваемые опции в PPP 

//CTS от модема  на  физический DSR контроллера
//реально отправилось не болеее 1474 (Wavecom) и 1472 (SonyErricson) данных UDP при MRU=1500 ( заголовки: 20 IP+8 UDP)
//два буфера на прием, прием по концу 0х7е

//__flash char com_AT[] = {'A','T'};
//__flash char com_ATE0V1[] = {'A','T','E','0','V','1'};
//__flash char com_AT_IRP[] = {'A','T','+','I','P','R','=','1','1','5','2','0','0'};
//__flash char com_AT_CGCLASS[] = {'A','T','+','C','G','C','L','A','S','S','=','"','C','G','"'};
//__flash char com_AT_CGATT[] = {'A','T','+','C','G','A','T','T','=','1'};
//__flash char com_AT_CGDCONT[] = {'A','T','+','C','G','D','C','O','N','T','=','1',',','"','I','P','"',','};
...
//__flash char ip_serv[] =    {'r','0',' ','I','P',' ','s','e','r','v','e','r','-','-','>' };             
//__flash char portik_udp[] = {'r','1',' ','U','D','P',' ','p','o','r','t','-','-','-','>' };
//__flash char in_group[] =   {'r','2',' ','G','R',' ','N','U','M','-','-','-','-','-','>' };
//__flash char in_self[] =    {'r','3',' ','N','U','M','B','E','R','-','-','-','-','-','>' };         
//__flash char user_name[] =  {'r','4',' ','U','s','e','r',' ','n','a','m','e','-','-','>' };
//__flash char passord[] =    {'r','5',' ','P','a','s','s','w','o','r','d','-','-','-','>' };
//__flash char init_line[] =  {'r','6',' ','I','n','i','t',' ','l','i','n','e','-','-','>' };
//__flash char ctrl_time[] = {'r','7',' ','C','t','r','l',' ','t','i','m','e','-','-','>' };
//__flash char rs_485_par[] = {'r','8',' ','R','S','-','4','8','5','-','-','-','-','-','>' };
//__flash char rx_out_tm[] =  {'r','9',' ','R','X','-','O','U','T','-','-','-','-','-','>' };
//__flash char tx_out_tm[] =  {'r','a',' ','T','X','-','O','U','T','-','-','-','-','-','>' };
//__flash char rcv_out_tm[] = {'r','b',' ','R','C','V','-','O','U','T','-','-','-','-','>' };                              
...
__flash unsigned char tab_crc[] = { 0,94,188,226,97,63,221,131,194,156,126,32,163,253,31,65,
...
__flash unsigned char s1[] = {0,15,1,14,2,13,3,12,4,11,5,10,6,9,7,8};
                    

__flash unsigned char s2[] = {1,9,2,10,3,11,4,12,5,13,6,14,7,15,8,0}; 
...
unsigned char ip_self[4],ip_pri_dns[4],ip_sec_dns[4],ip_serv_gprs[4],ip_ls[4]; 
...
struct
 ...
 ///описание!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  enum t_state_modem {STM_NONE=0,STM_ON,STM_SS,STM_SI,STM_SC,STM_SCP,STM_PPP,STM_RDC,STM_DC,STM_OFF};
...
fl_at_com;
 ...
 unsigned char mon2 : 1;
  ...
  unsigned int  vol_tm_tx_out;    // предел счетчик времени на удержание rts после передачи
...
struct {
 ...
 unsigned char Emul_232_cnt_post_tx;  //защитный интервал на переключения на прием, чтоб не всасывались куски
...
// buf_tx_232[35]=0;              
 ...
 buf_tx_232[TR_ID]=Obj_ppp_tx.id_pac; 
   ...
   *(unsigned int*)&buf_tx_232[TR_SRC]=Obj_ppp_tx.num_src;   //номер отправителя
   *(unsigned int*)&buf_tx_232[TR_DST]=Obj_ppp_tx.num_dst;   //номер получателя 
...
//  buf_tx_232[35]=temp.bytes[0]; 
  ...
  //crc
  *(unsigned int*)&buf_tx_232[TR_CRC]=crc_m1(&buf_tx_232[TR_LEN],*(unsigned int*)&buf_tx_232[TR_LEN]-2,0xffff);
  }
  else 
  {
 ...
 // *(unsigned int*)&buf_tx_232[UDP_CRC]=calc_crc_udp(&buf_tx_232[UDP_PSRC],temp.word);
  *(unsigned int*)&buf_tx_232[UDP_CRC]=calc_crc_udp_2(&buf_tx_232[0],temp.word);
...
unsigned char check_cont_485_1 (unsigned char *pointer)
{
                ...
                switch ((*(pointer+1)) & 0x07)
                  ...
                  if((*(unsigned int*)(pointer+2))>10000)return(1);
                  
                  if((*(unsigned int*)(pointer+4))==0)return(1);
                  if((*(unsigned int*)(pointer+4))>10000)return(1);
                  
                  if((*(unsigned int*)(pointer+6))<3)return(1);
...
unsigned char run_cont_485_2 (unsigned char *pointer)
{
                    ...
                    switch ((*(pointer+1)) & 0x07)
                           {
                           case NON: Emul_485.fl_bit_chet=0;
                                 break;
                           case ODD:  Emul_485.fl_bit_chet=1;
                                 break;
                           case EVEN: Emul_485.fl_bit_chet=2;
                                 break;
                           default: return(1);
                           }
 ...
 next_parametr: 
               ...
               switch(buf_rx_ppp[ind]&0x7f)
                 ...
                 case CONF_VERS:  if((buf_rx_ppp[ind] & 0x80)==0x80)goto bad_com;
                                    ...
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_RD_CONF_VERS)goto bad_com;   
                                    }
                                   ...
                                   *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=buf[0]+1;
                 ...
                 case CONF_MAP:  if((buf_rx_ppp[ind] & 0x80)==0x80)goto bad_com;
                                    ...
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_RD_CONF_MAP)goto bad_com;   
                                    }
                                   buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  
                                   buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                ...
                case CONF_OZU:  if((buf_rx_ppp[ind] & 0x80)==0x80)goto bad_com;
                                    ...
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_RD_CONF_OZU)goto bad_com;   
                                    }
                                   buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  
                                   buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                 ...
                 case CONF_TM_NAT:  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_TM_NAT)goto bad_com;
                                    //запись
                                    ...
                                    *(unsigned int*)&buf[OFS_C_PAR_CRC]=crc_m1(&buf[0],L_C_PAR-2,0xffff);
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_TM_NAT-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_TM_NAT+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_C_PAR+OFS_NAT,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
                   ...
                   case CONF_TM_CC:  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_TM_CC)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                    ...
                                    *(unsigned int*)&buf[OFS_C_PAR_CRC]=crc_m1(&buf[0],L_C_PAR-2,0xffff);
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_TM_CC-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_TM_CC+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_C_PAR+OFS_CCH,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
                    ...
                    case CONF_TM_WT :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_TM_WT)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                    ...
                                    *(unsigned int*)&buf[OFS_C_PAR_CRC]=crc_m1(&buf[0],L_C_PAR-2,0xffff);
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_TM_WT-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_TM_WT+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_C_PAR+OFS_TM_CH,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
               ...
               case CONF_NUM_CL :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_NUM_CL)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                    ...
                                    *(unsigned int*)&buf[OFS_SEQ_PAR_CRC]=crc_m1(&buf[0],L_SEQ_PAR-2,0xffff);
                                    WrArrayToFlesh(A_SEQ_PAR, &buf[0],L_SEQ_PAR,0,0);
                                    prov_ozu=crc_ozu();
                                    }
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_NUM_CL-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_NUM_CL+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_SEQ_PAR+OFS_NUM_CL,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
               ...
               case CONF_TM_VZ :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_TM_VZ)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                    ...
                                    *(unsigned int*)&buf[OFS_SEQ_PAR_CRC]=crc_m1(&buf[0],L_SEQ_PAR-2,0xffff);
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_TM_VZ-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_TM_VZ+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_SEQ_PAR+OFS_TM_VZ,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
               ...
               case CONF_TM_CL :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_TM_CL)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                    ...
                                    *(unsigned int*)&buf[OFS_SEQ_PAR_CRC]=crc_m1(&buf[0],L_SEQ_PAR-2,0xffff);
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_TM_CL-2))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_TM_CL+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_SEQ_PAR+OFS_TM_CL,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
             ...
             case CONF_DES_OHR :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_DES_OHR)goto bad_com;
                                    //запись
                                    ...
                                    *(unsigned int*)&buf[OFS_SEQ_PAR_CRC]=crc_m1(&buf[0],L_SEQ_PAR-2,0xffff);
                                    ...
                                    if(Appl_seq_des!=1)monitor_beg_state_seq(1);
                                    
                                    }
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_DES_OHR-1))goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_DES_OHR+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                    RdFromFleshToArr(A_SEQ_PAR+OFS_DES_SEQ,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],1);
                 ...
                 case CONF_NUM_SELF :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_NUM_SELF)goto bad_com;
                                    //запись
                                    temp=*(unsigned int*)&buf_rx_ppp[ind+3];
                                  ...
                                  //  prov_ozu=crc_ozu();
                                    ...
                                    else if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_NUM_SELF-2))goto bad_com;
                                         

                                    RdFromFleshToArr(A_IP_PAR+OFS_NUM,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_NUM_SELF+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                  ...
                  case CONF_UDP :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_UDP)goto bad_com;
                                    ...
                                    *(unsigned int*)&buf[OFS_IP_PAR_CRC]=crc_m1(&buf[0],L_IP_PAR-2,0xffff);
                                    ...
                                    else if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_UDP-2))goto bad_com;
                                      

                                     
                                    RdFromFleshToArr(A_IP_PAR+OFS_PORT,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],2);
                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_UDP+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                   ...
                   case CONF_IP :  
                                  ...
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_CONF_IP)goto bad_com;
                                    ...
                                    *(unsigned int*)&buf[OFS_IP_PAR_CRC]=crc_m1(&buf[0],L_IP_PAR-2,0xffff);
                                    ...
                                    else if(*(unsigned int*)&buf_rx_ppp[ind+1]!=(L_CONF_IP-4))goto bad_com;
                                        
                                    RdFromFleshToArr(A_IP_PAR+OFS_IP,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],4);  
                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение
                                    *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_CONF_IP+1;   
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                   ...
                   case CONF_PDP :                                                  
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    ...
                                    else {if(*(unsigned int*)&buf_rx_ppp[ind+1]!=0)goto bad_com;}
                                     

                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];  //чтение                                    
                                    buf_tx_232[TR_OP_DATA+C1_DATA+3+cnt_bt]=0x00; //OK  
                                  
                                    RdFromFleshToArr(A_C_GPRS,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],L_C_GPRS_MAX);
               ...
               case CONF_RESET:          
                                 if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=0)goto bad_com;
                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];
                 ...
                 case CONF_PDP_DOP :                                                  
                                  if((buf_rx_ppp[offset+C1_DATA] & 0x80)==0x80)
                                    ...
                                    RdFromFleshToArr(ABUF_C_GPRS,&buf_tx_232[TR_OP_DATA+C1_DATA+4+cnt_bt],temp); 
                                    buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind]; 
                 ...
                 case CONF_TIME:
                                 if((buf_rx_ppp[ind] & 0x80)==0x80)
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_WR_CONF_TIME)goto bad_com;
                                    //запись времени           
                                    set_rlt(0,&buf_rx_ppp[ind+3]);
                                    }
                                    else
                                    {
                                    if(*(unsigned int*)&buf_rx_ppp[ind+1]!=L_RD_CONF_TIME)goto bad_com;   
                                    }
                                    
                                  buf_tx_232[TR_OP_DATA+C1_DATA+cnt_bt]=buf_rx_ppp[ind];
                                  *(unsigned int*)&buf_tx_232[TR_OP_DATA+C1_DATA+1+cnt_bt]=L_WR_CONF_TIME+1;
...
unsigned char proc_option(unsigned char *buf_rx_ppp,unsigned int ind,unsigned int count_rx_opt)
 {
...
unsigned char cnt=0;
 ...
 if(cnt>=count_rx_opt)return(1);//все опции просчитаны
...
void send_size_pg(unsigned char id,unsigned int dst)
 ...
 unsigned char proc_udp_data(unsigned char *buf_rx_ppp,unsigned int count_rx_ppp)
              ...
              // unsigned int ii;
               ...
               //проверка crc
                if(*(unsigned int*)&buf_rx_ppp[TR_CRC]!=crc_m1(&buf_rx_ppp[TR_LEN],*(unsigned int*)&buf_rx_ppp[TR_LEN]-2,0xffff))return(0);         
              ...
              /* 
               ...
               if((buf_rx_ppp[TR_V]&0x0f)*4>MIN_TR_HEAD)
                  ...
                  //здесь обработка возможных опций транспортного заголовка
                    // пока обработка одной опции - отсутствие указанного адресата в информационном поле
               ...
               */
               ...
               if(length==0) //если длина данных 0 то контроль связи и проверка
                  ...
                  if(length_head>MIN_TR_HEAD)
                    {
                     if (proc_option(buf_rx_ppp,TR_OP_DATA,length_head-MIN_TR_HEAD)==2)
                       {
...
//                  if(buf_rx_ppp[TR_ID]!=ID_CC)return(0);
                       ...
                       case PORT485_1:
                            ...
                            if(Appl_RS485_1.fl_data_buf==TRUE)
                               ...
                               break;
                                ...
                                if(length_head>MIN_TR_HEAD)
                                  {
                                    if (proc_option(buf_rx_ppp,TR_OP_DATA,length_head-MIN_TR_HEAD)!=1)return(0);                                                                  
  ...
  otv_conf:                        
                           ...
                           clr_cntr_link();
                                ...
                                if((fl_rewrite.udp==1)||(fl_rewrite.udp==1)||(fl_rewrite.num_self==1))
                                   {
...
////////////////////////////////////
          test_alert();          
           g2[0]++;g2[1]++;g2[2]++;g2[3]++;
           g2[4]++;g2[5]++;g2[6]++;g2[7]++;
           g2[8]++;g2[9]++;g2[10]++;g2[11]++;
           g2[12]++;g2[13]++;g2[14]++;g2[15]++;
             //     __disable_interrupt();
                  cccc=0;
            ...
            //
                 ...
                 switch(count)
                              ...
                              {
                              case 0: {PORTD=PORTD & ~0x80 ;
                                       PORTG=PORTG | 1;
                                       PORTC=PORTC | 1;
                                       PORTC=PORTC | 0x10;
                                       break;}
                               case 1: {PORTD=PORTD | 0x80 ;
                                       PORTG=PORTG & ~1;
                                       PORTC=PORTC | 1;
                                       PORTC=PORTC | 0x10;
                                       break;}
                                case 2: {PORTD=PORTD | 0x80 ;
                                       PORTG=PORTG | 1;
                                       PORTC=PORTC & ~1;
                                       PORTC=PORTC | 0x10;
                                       break;}  
                                case 3: {PORTD=PORTD | 0x80 ;
                                        PORTG=PORTG | 1;
                                       PORTC=PORTC | 1;
                                       PORTC=PORTC & ~0x10;
                                       break;}                     
...
if(Emul_485.dir_tx==TRUE)
{
                        ...
                        if(Emul_485.cnt_bit==10) //вставка паритета если нужно
                           ...
                           switch(Emul_485.fl_bit_chet)
                             {
                             case 2:
                                       if(Emul_485.bit_par) {SETB485_2;}  else {CLR485_2;}   // int-registr
                                       return;            
                             case 1:
                                       if(Emul_485.bit_par) {CLR485_2;}  else {SETB485_2;}   // int-registr
                                       return;
                             }   
                           }
                      ...
                      //  if((Emul_485.shift_reg & 1)==0) CLR485_2;
                       ...
                       if(Emul_485.shift_reg & 1){ SETB485_2;} else {CLR485_2;} // int-registr  
                        Emul_485.shift_reg=Emul_485.shift_reg >> 1;
                         
                        Emul_485.bit_par=Emul_485.bit_par ^(Emul_485.shift_reg & 0x01); //подсчет паритета 
                        ...
                        if(Emul_485.cnt_bit>=10)
                                        ...
                                        if(Rs485_2.cnt_bt_rx_tx==0)
                                                ...
                                                {         
                                                 TIMSK=TIMSK & ~0x08;
                                                if(Rs485_2.vol_tm_tx_out==0)set_em_485_rx();
                                                      else Rs485_2.cnt_tm_tx_out=Rs485_2.vol_tm_tx_out; 
                                                }
                                      }
...
///
...
else
              {
               ...
               //  if  ((Emul_485.cnt_bit==1)&&((PIND & IN_BIT485_2)==IN_BIT485_2))
                ...
                if((PIND & IN_BIT485_2)==IN_BIT485_2) Emul_485.shift_reg=Emul_485.shift_reg | 0x8000;
                if((PIND & IN_BIT485_2)==0) Emul_485.shift_reg=Emul_485.shift_reg & ~0x8000;
                        ...
                        if(Emul_485.cnt_bit>=10)
                                       ...
                                       // Rs485_2.cnt_bt_rx_tx++;        
                                        ...
                                        EIMSK=EIMSK | 0x02;                                         
                                        /*
                                        if(Rs485_2.cnt_tm_rx_out<=MAX_BUF_RS485_2) *Rs485_2.p_data485++=(unsigned char)(Emul_485.shift_reg>>8);//переполнение
                                           else 
                                              {                        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                              Rs485_2.cnt_bt_rx_tx--;
                                              }
                                        */
                                        ...
                                        if( Rs485_2.cnt_bt_rx_tx < MAX_BUF_RS485_2)
                                           {
                                             Rs485_2_buf_rx_tx[Rs485_2.cnt_bt_rx_tx]=(unsigned char)(Emul_485.shift_reg>>8);
                                             Rs485_2.cnt_bt_rx_tx++;
                                            }
...
if(Emul_232.dir_tx==TRUE)
{
                        ...
                        Emul_232.cnt_bit++;
                        if((Emul_232.shift_reg & 1)==1) SETB232_2;  // int-registr
                        if((Emul_232.shift_reg & 1)==0) CLR232_2;
                        Emul_232.shift_reg=Emul_232.shift_reg >> 1;
                        ...
                        if(Emul_232.cnt_bit==10)
                                        ...
                                        if(Rs232_2.cnt_bt_rx_tx==0)
                                                ...
                                                {  
                                                 ...
                                                 Emul_232_cnt_post_tx=DEF_EM232_POST_TX; //установка защитного интервала на прием
                                                 fl_232_2.busy=0;       
...
///
...
else
              {
                ...
                if((PINE & IN_BIT232_2)==IN_BIT232_2) Emul_232.shift_reg=Emul_232.shift_reg | 0x8000;
                if((PINE & IN_BIT232_2)==0) Emul_232.shift_reg=Emul_232.shift_reg & ~0x8000;
                        ...
                        if(Emul_232.cnt_bit>=10)
                                        ...
                                        if( Rs232_2.cnt_bt_rx_tx < MAX_BUF_RS232_2)
                                           {
                                             Rs232_2_buf_rx_tx[Rs232_2.cnt_bt_rx_tx]=(unsigned char)(Emul_232.shift_reg>>8);
                                             Rs232_2.cnt_bt_rx_tx++;
                                            }
                                             else fl_232_2.over=1;
  ...
  if(fl_cts_232.on==1)
    {
      if(fl_cts_232_ignor==TRUE)
            {
             fl_cts_232.on=0;
             if(count_tx_ppp==0){SVD2_1_ON;UDR0=buf_tx_232[0];}
...
next_step1:
               ...
               if(Rs485_1.cnt_tm_pre_tx==0) goto  next_step2;
               Rs485_1.cnt_tm_pre_tx--;
               if(Rs485_1.cnt_tm_pre_tx==0) UCSR1B=UCSR1B | UDRIE;  // enable transmit 485_1 
...
next_step2:
                ...
                if(Rs485_1.cnt_tm_out==0) goto next_step3;
                Rs485_1.cnt_tm_out--;
...
next_step3:      
                 ...
                 if(Rs485_1.cnt_tm_rx_out==0) goto next_step4;
...
next_step4:                  
                if(Rs485_1.cnt_tm_tx_out==0) goto next_step5;
                Rs485_1.cnt_tm_tx_out--;
                if(Rs485_1.cnt_tm_tx_out==1) clr_rts_485_1;  // togle to receiv mode  
                if(Rs485_1.cnt_tm_tx_out==0){Rs485_1.cnt_tm_out=Rs485_1.vol_tm_out;UCSR1B =UCSR1B | RXEN | RXCIE;} // togle to receiv mode ;
                
                 
next_step5:      


               if(Rs485_2.cnt_tm_pre_tx==0) goto  next_step6;
...
next_step6: 
                ...
                if(Rs485_2.cnt_tm_out==0) goto next_step7;
                Rs485_2.cnt_tm_out--;
 ...
 next_step7:               
               ...
               if(Rs485_2.cnt_tm_rx_out==0) goto next_step8;
...
next_step8:
                ...
                if(Rs485_2.cnt_tm_tx_out==0) goto next_step9;
                Rs485_2.cnt_tm_tx_out--;  
                if(Rs485_2.cnt_tm_tx_out==0)set_em_485_rx();// установка на прием

next_step9:

        
        if(Rs232_2.cnt_tm_rx_out==0) goto next_step10;
               Rs232_2.cnt_tm_rx_out--;
                if(Rs232_2.cnt_tm_rx_out==0)
                    { 
                       
                       if(((fl_232_2_add.sinc==1)&&(fl_232_2_add.was_tx==1)) || (Emul_232_cnt_post_tx!=0))
                        {
...
next_step10: 
            ...
            if (Emul_232_cnt_post_tx==0)goto next_step11;
                Emul_232_cnt_post_tx--;
               if (Emul_232_cnt_post_tx==0)fl_232_2_add.was_tx=0;; 
next_step11:            
                    ...
                    if(temp==0x7d)
                       ...
                       {  
                         if (fl_rx_ppp.fl_7d==1)
                            {                 
                              if((temp>=0x20)&&(temp<0x40)){Buf1_rx_ppp.data[Buf1_rx_ppp.ln_data]=temp-0x20;Buf1_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);}                                
                              if(temp==0x5e){Buf1_rx_ppp.data[Buf1_rx_ppp.ln_data]=0x7e;Buf1_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);}  
                              if(temp==0x5d){Buf1_rx_ppp.data[Buf1_rx_ppp.ln_data]=0x7d;Buf1_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);} 
                              Buf1_rx_ppp.ln_data=0;
                              fl_rx_ppp.fl_7e=0;
                              fl_rx_ppp.fl_7d=0;
                              SVD2_2_OFF;
                       ...
                       {  
                         if (fl_rx_ppp.fl_7d==1)
                            { 
                              ...
                              if((temp>=0x20)&&(temp<0x40)){Buf2_rx_ppp.data[Buf2_rx_ppp.ln_data]=temp-0x20;Buf2_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);}                                
                              if(temp==0x5e){Buf2_rx_ppp.data[Buf2_rx_ppp.ln_data]=0x7e;Buf2_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);}  
                              if(temp==0x5d){Buf2_rx_ppp.data[Buf2_rx_ppp.ln_data]=0x7d;Buf2_rx_ppp.ln_data++;fl_rx_ppp.fl_7d=0;return(0);} 
                              Buf2_rx_ppp.ln_data=0;
                              fl_rx_ppp.fl_7e=0;
                              fl_rx_ppp.fl_7d=0;
                              SVD2_2_OFF;
           ...
           __interrupt  void UART_RX_interrupt(void)
                {
                 ...
                 if (fl_at_mom_232==1)
                {
                  if(vol_tx_ppp>=VOL_TX_PPP)vol_tx_ppp=0;
                 ...
                 if(fl_rx_ppp.switcher==0)
                    {
                     if(recive_buf1(temp)==1)
                        {
                         if(count_rx_232>=kol_rx_232)return;
...

{
 ...
 if(Rs485_1.cnt_bt_rx_tx==0) goto end_tx1;
...
if (fl_reg3.add_byte==1) 
    {         
      fl_reg3.add_byte=0;
      if (buf_tx_232[count_tx_ppp]==0x7e){UDR0=0x5e;return;}  
      if (buf_tx_232[count_tx_ppp]==0x7d){UDR0=0x5d;return;} 
       ...
       switch (LCP_act_buf[uk_out_act_LCP])
          {
           ...
           case SCJ:   
                ...
                for(i=0;i<ln_rejc_lcp;i++)buf_tx_232[9+i]=buf_rejc_opt_lcp[i];
                temp.word=pppfcs16(PPPINITFCS16,&buf_tx_232[1],temp.word) ^ 0xffff;                  
        ...
        {        
               ...
               /* 
                 ...
                 if((temp.bytes[1]==0)||(temp.bytes[1]>MAX_VOL_PSW)) buf_tx_232[8+buf_tx_232[7]]=0;
                    else RdFromFleshToArr(A_C_GPRS+temp1+temp.bytes[0]+3,&buf_tx_232[9+buf_tx_232[7]],temp.bytes[1]);   
              */
       ...
       switch (IPCP_act_buf[uk_out_act_IPCP])
          {
           ...
           case SCJ:   
                ...
                for(i=0;i<ln_rejc_ipcp;i++)buf_tx_232[7+i]=buf_rejc_opt_ipcp[i];
                temp.word=pppfcs16(PPPINITFCS16,&buf_tx_232[1],temp.word) ^ 0xffff;                  
...
void monitor_event_IPCP(void)
 ...
 end_pcp_opt_1:        
  ...
  end_pcp_opt_2:      if((fl_opt.accm==1)&&(fl_opt.acfc==1)&&(fl_opt.pfc==1))
                  ...
                  case TERM_REQ :
                       ...
                       return(1); 
                  case TERM_ACK : 
                      if(buf_rx_ppp[6]!=i_str_lcp)return(1); 
                      LCP_event=RTA;
       ...
       next_opt_ipcp_1:  if(count_length_opt==vol_length_opt) goto end_ipcp_opt_1;   //обработаны все опции
                       ...
                       switch(buf_rx_ppp[ind_opt])
                         ...
                         */
                           default:  // подтверждать все !!!!!!!!!!
                                        ...
                                        for(i=0;i<buf_rx_ppp[ind_opt+1];i++){buf_ack_opt_ipcp[ln_ack_ipcp]=buf_rx_ppp[ind_opt+i];ln_ack_ipcp++;}
                                        count_length_opt=count_length_opt+buf_rx_ppp[ind_opt+1];        
                                        ind_opt=ind_opt+buf_rx_ppp[ind_opt+1];      
                                  goto next_opt_ipcp_1;        
 ...
 end_ipcp_opt_1:        
   ...
   next_opt_ipcp_2:  if(count_length_opt==vol_length_opt) goto end_ipcp_opt_2;   //обработаны все опции
                          ...
                          { 
                            ...
                            case IP_PRI_DNS:       
                                  if (buf_rx_ppp[ind_opt+1]!=6)
                                    ...
                                    if ( 
                                           (buf_rx_ppp[ind_opt+2]==ip_pri_dns[0])&&
                            ...
                            case IP_SEC_DNS:       
                                  if (buf_rx_ppp[ind_opt+1]!=6)
                                    ...
                                    if ( 
                                           (buf_rx_ppp[ind_opt+2]==ip_sec_dns[0])&&
  ...
  end_ipcp_opt_3:                                        
                  ...
                  case TERM_REQ :
                       ...
                       return(1); 
                  case TERM_ACK : 
                      if(buf_rx_ppp[4]!=i_str_ipcp)return(1); 
                      IPCP_event=RTA;
...
{
  unsigned int i;
  if(fl_485_2.busy==1)return;
  if((fl_485_2.tx==1)||(Appl_RS485_2.fl_data_buf==TRUE))
    {
    if(fl_485_2.tx==1)fl_485_2.tx=0;
    if(Appl_RS485_2.fl_data_buf==TRUE)Appl_RS485_2.fl_data_buf=FALSE;
    ...
    for(i=0;i<Rs485_2.cnt_bt_rx_tx;i++)Rs485_2_buf_rx_tx[i]=Appl_RS485_2_data_buf[i];
    Rs485_2.p_data485=&Rs485_2_buf_rx_tx[0];
...
void monitor2_tx_rs485_1(void)
{
  ...
  if(fl_232_2.buffed==1)
    ...
    for(i=0;i<Rs485_1.cnt_bt_rx_tx;i++)Rs485_1_buf_rx_tx[i]=Rs232_2_buf_rx_tx[i];
...
void monitor2_tm_rs485_1(void)
  {
  if(fl_tx485.mon2==0)return;
  if(fl_485_1.tm_out==0)return;
...
void monitor2_rec_rs485_1(void)
  ...
  unsigned int i;
  if(fl_tx485.mon2==0)return; 
  if(fl_485_1.rec==0)return;
  fl_485_1.rec=0;
  
 
  
  if(fl_485_1.over==1) fl_485_1.over=0; // все равно посылка сколько нагреблось
     
  if(Rs485_1.cnt_bt_rx_tx>MAX_BUF_RS232_2) Rs232_2.cnt_bt_rx_tx=MAX_BUF_RS232_2;
     else Rs232_2.cnt_bt_rx_tx=Rs485_1.cnt_bt_rx_tx;   // выдать посылку модема 
  
  if(kamintel==1)Rs232_2.cnt_bt_rx_tx--;
  
  for(i=0;i<Rs232_2.cnt_bt_rx_tx;i++)Rs232_2_buf_rx_tx[i]=Rs485_1_buf_rx_tx[i];      //перепись в буфер
...
void monitor1_tx_rs485_1(void)
{
  ...
  if((fl_485_1.tx==1)||(Appl_RS485_1.fl_data_buf==TRUE))
    {
    if(fl_485_1.tx==1)fl_485_1.tx=0;
    if(Appl_RS485_1.fl_data_buf==TRUE)Appl_RS485_1.fl_data_buf=FALSE;
    fl_485_1.busy=1;
    fl_tx485.mon1=1;
    ...
    for(i=0;i<Rs485_1.cnt_bt_rx_tx;i++)Rs485_1_buf_rx_tx[i]=Appl_RS485_1_data_buf[i];
    Rs485_1.p_data485=&Rs485_1_buf_rx_tx[0];
    //здесь должна быть функция настройки порта по контексту.
...
void monitor1_tm_rs485_1(void)
  ...
  fl_485_1.tm_out=0; 
  if((PIND & DCD)==0) send_err485(NUM_RS485_1,RS_NO_LINK,Appl_RS485_1.id_tek,Appl_RS485_1.dst_tek);// игнорировать передачу если нет GPRS канала
  fl_485_1.busy=0; 
  fl_tx485.mon1=0;
  }
...
void monitor1_rec_rs485_1(void)
  ...
  if(fl_485_1.over==1)
     {
     fl_485_1.over=0;
     send_err485(NUM_RS485_1,RS_OVER_BUF_RX,Appl_RS485_1.id_tek,Appl_RS485_1.dst_tek);
     Rs485_1.cnt_bt_rx_tx=0;
     fl_485_1.busy=0;
     fl_tx485.mon1=0; 
     return; 
   ...
   if(Rs485_1.cnt_bt_rx_tx+100>VOL_TX_PPP)
      {
      send_err485(NUM_RS485_1,RS_OVER_BUF_PPP_TX,Appl_RS485_1.id_tek,Appl_RS485_1.dst_tek);
      Rs485_1.cnt_bt_rx_tx=0;
      fl_485_1.busy=0;
      fl_tx485.mon1=0; 
      return; 
  ...
  Obj_ppp_tx.kol_opt=0;// количество опций 
    ...
    for(i=0;i<Rs485_1.cnt_bt_rx_tx;i++)buf_tx_232[TR_OP_DATA+C1_DATA+i]=Rs485_1_buf_rx_tx[i];
...
void send_err485(unsigned char port,unsigned char err,unsigned char id,unsigned int dst)
 ...
 void monitor_tm_rs485_2(void)
  {
  if(fl_ip.act_ip_end!=1)return;  
  if(fl_485_2.tm_out==0)return;
  fl_485_2.tm_out=0; 
  clr_cntr_nat();
  clr_cntr_link(); 
  if((PIND & DCD)==0)send_err485(NUM_RS485_2,RS_NO_LINK,Appl_RS485_2.id_tek,Appl_RS485_2.dst_tek);// игнорировать передачу если нет GPRS канала
  fl_485_2.busy=0; 
  }
 ...
 void monitor_rec_rs485_2(void)
  ...
  if(fl_485_2.over==1)
     ...
     fl_485_2.over=0;
     send_err485(NUM_RS485_2,RS_OVER_BUF_RX,Appl_RS485_2.id_tek,Appl_RS485_2.dst_tek);
     Rs485_2.cnt_bt_rx_tx=0;
     fl_485_2.busy=0; 
     return; 
     }
   ...
   if(Rs485_2.cnt_bt_rx_tx+100>VOL_TX_PPP)
      {
      send_err485(NUM_RS485_2,RS_OVER_BUF_PPP_TX,Appl_RS485_2.id_tek,Appl_RS485_2.dst_tek);
      Rs485_2.cnt_bt_rx_tx=0;
      fl_485_2.busy=0; 
      return; 
      }
  ...
  Obj_ppp_tx.kol_opt=0;// количество опций 
    ...
    for(i=0;i<Rs485_2.cnt_bt_rx_tx;i++)buf_tx_232[TR_OP_DATA+C1_DATA+i]=Rs485_2_buf_rx_tx[i];
 ...
 void count_crc_dallas(unsigned char *p_beg,unsigned int kol,unsigned char *p_crc)
{
unsigned int i;

   *p_crc=0;  
   for(i=0;i<kol;i++)*p_crc=tab_crc[(*p_crc) ^ (*(p_beg+i))];//проверка сrc
}
 ...
 //reset_em_232_new();
  ...
  if(Rs232_2.cnt_bt_rx_tx> (MAX_BUF_RS485_1-1)) 
    ...
    if((Rs232_2_buf_rx_tx[Rs232_2.cnt_bt_rx_tx-2]!= tempus.bytes[1])||(Rs232_2_buf_rx_tx[Rs232_2.cnt_bt_rx_tx-1]!= tempus.bytes[0]))
     {
       ...
       if(Rs232_2_buf_rx_tx[1]==1) //это к самому контроллеру 
          {
           switch(Rs232_2_buf_rx_tx[0])
               ...
               case 18:
                      ...
                      if(PIND & PIN_AKB_SET)Rs232_2_buf_rx_tx[4]=0x64;else Rs232_2_buf_rx_tx[4]=0x74;
     ...
     count_crc_dallas(&Rs232_2_buf_rx_tx[0],Rs232_2.cnt_bt_rx_tx,&Rs232_2_buf_rx_tx[Rs232_2.cnt_bt_rx_tx]);
     Rs232_2.cnt_bt_rx_tx++;
     kamintel=1;
     }
...
if (Appl_seq_des==1){MCUCSR=0;return;}// блокировка 
...
if((MCUCSR & 0x02)==0x02)write_log_info(ST_PIT_ON,RESET_EXT);
if((MCUCSR & 0x04)==0x04)write_log_info(ST_PIT_ON,RESET_BROWN);
if((MCUCSR & 0x08)==0x08)write_log_info(ST_PIT_ON,RESET_WDR);
...
*(unsigned long int*)&buf[3]=burst_ds_r();
if((MCUCSR & 0x02)==0x02)buf[7]=RST_EXT;
if((MCUCSR & 0x04)==0x04)buf[7]=RST_BROWN;
if((MCUCSR & 0x08)==0x08)buf[7]=RST_WDR;
buf[8]=0;
...
void monitor_over_net(void)
   {        
     ...
     if (((PIND & PIN_AKB_SET)&&(byte_state_net==YES_NET))|| (((PIND & PIN_AKB_SET)==0)&&(byte_state_net==NO_NET)))
          {
            if(byte_state_net==YES_NET) byte_state_net=NO_NET;
            else byte_state_net=YES_NET;
            count_block_net=3;
            buf[0]=AKB_SET;
...
sv_tc.bytes[0]=~((real_tc.arr_tc[0] & 0xf) | ((real_tc.arr_tc[1]<<4) & 0xf0));
sv_tc.bytes[1]=~((real_tc.arr_tc[2] & 0xf) | ((real_tc.arr_tc[3]<<4) & 0xf0));
...
if (Appl_seq_des==1)return;// блокировка опроса охранки            
 ...
 if (PIND & PIN_AKB_SET) byte_state_net=NO_NET;else byte_state_net=YES_NET;
            count_block_net=3;
            buf[0]=AKB_SET;
            *(unsigned int*)&buf[1]=L_AKB_SET;
            *(unsigned long int*)&buf[3]=burst_ds_r();
...
void led_alarm(void)
{
  if(glutch<1){led_sost_s_off;}                              
  if(glutch==1){led_sost_s_on;}
  if(glutch>1)glutch=0;
}
 

void led_vzatie(void)
{
  if(glutch<2){led_sost_s_off;}                              
  if(glutch>2){led_sost_s_on;}
}
...
if (Appl_seq_des==1){led_sost_s_off;led_ohrn_s_off;return;}// блокировка опроса охранки
...
if(sv_tc.bytes[0] & 0x01){led_ohrn_s_off;} else {led_ohrn_s_on;}


if( (sv_tc.bytes[0]&0x01)!=(sv_tc_old.bytes[0]&0x01))
  {
  if(sv_tc.bytes[0] & 0x01)Appl_seq.event=EV_TC_NORMA; else Appl_seq.event=EV_TC_ALARM;
  sv_tc_old.word=sv_tc.word;
  }
...
void Application_SEQ_tx()
{
 ...
 if((fl_lcp.act_lcp_end!=1)&&(fl_pap.act_pap_end!=1)||(fl_ipcp.act_ipcp_end!=1)||(fl_ip.act_ip_end!=1))return;
      //проверять здесь готово ли для отправки буфер PPP 
        ...
        Obj_ppp_tx.l_data=read_from_buf(&Appl_seq_buf[0],&Appl_seq.p_in,&Appl_seq.p_out,&Appl_seq.p_out_kv,&Appl_seq.crc,&buf_tx_232[TR_OP_DATA+C1_DATA],sizeof(Appl_seq_buf));  
...
void load_rw_pdp(void)
{
 ...
 if((MCUCSR & 0x01)!=0x01)return;
 if (e_rw_pdp!=0)return;
 ...
 if(buf[0]!=0)
   {
    ...
    kol=0;
       ...
       temp=strlen(&buf[j]);
       if(temp>35){e_rw_pdp=0xff;return;}
       buf_tx_232[j]=temp;
       for(i=0;i<temp;i++) {buf_tx_232[j+1]=buf[j];j++;}
       kol=kol+temp;
       
       j++;
       temp=strlen(&buf[j]);
       if(temp>15){e_rw_pdp=0xff;return;}
       buf_tx_232[j]=temp;
       for(i=0;i<temp;i++) {buf_tx_232[j+1]=buf[j];j++;}
       kol=kol+temp;
       ...
       kol=kol+3;      
       if(kol>(L_C_GPRS_MAX-2)){e_rw_pdp=0xff;return;}
       
       *(unsigned int*)&buf_tx_232[L_C_GPRS_MAX-2]=crc_m1(&buf_tx_232[0],L_C_GPRS_MAX-2,0xffff);
...
RdFromFleshToArr(A_IP_PAR,&buf[0],L_IP_PAR);
if(*(unsigned int*)&buf[OFS_IP_PAR_CRC]!=crc_m1(&buf[0],L_IP_PAR-2,0xffff))
  {
...
RdFromFleshToArr(A_C_PAR,&buf[0],L_C_PAR);
if(*(unsigned int*)&buf[OFS_C_PAR_CRC]!=crc_m1(&buf[0],L_C_PAR-2,0xffff))
  {
...
RdFromFleshToArr(A_SEQ_PAR,&buf[0],L_SEQ_PAR);
if(*(unsigned int*)&buf[OFS_SEQ_PAR_CRC]!=crc_m1(&buf[0],L_SEQ_PAR-2,0xffff))
  {
...
if(*(unsigned int*)&buf[OFS_PORT_GPRS_CRC]!=crc_m1(&buf[0],L_PORT_GPRS-2,0xffff))
  {
  ...
  else
  {
   ...
   if(*(unsigned long int*)&buf[OFS_GPRS_S]==115200)
    ...
    if(buf[OFS_GPRS_DES]!=1)start_func_stm_on();
  }
...
void monitor_ppp(void)
 ...
 // DDRC=DDRC | DTR;    //DTR  на выход
  ...
  if (check_memory_map()==1) vosstan_memory();
  ...
  while(1){
            ...
            switch(state_modem)
               {
                  ...
                  case STM_SCP:
                              ...
                              switch(event_modem)
                                     ...
                                     */
                                     if(PIND & DCD)event_modem=EVM_DCD_ERR;
          ...
          */
                             ...
                             // event_modem=EVM_DCD_ERR;
                              if((fl_tx485.mon1==0)&&(fl_485_2.busy==0)&&(fl_ip.act_ip_end==1))
                               {
                  ...
                  case STM_RDC:
                                                //GPRS-штатный RS485 // это остается чтобы обеспечить работу по радиомодему
                                                monitor1_rec_rs485_1();
                                                monitor1_tm_rs485_1();
