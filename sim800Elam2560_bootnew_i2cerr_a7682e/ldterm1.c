...
__flash char map_vers[] = {'F', 'M', '0', '2', '.', '0', '1',
                           ':', '1', '9', '1', '1', '0', '7'};
__flash char map_test_mtc[] = {'T', 'E', 'C', 'T', '.', 'M', 'T',
                               'C', ' ', 'M', 'O', 'D', 'U', 'L'};

__flash char str_loop_ok[] = {"LOOP 485_1"};
__flash char str_loop2_ok[] = {"LOOP 485_2"};
__flash char versia[] = {
    "M2560 A7682E 02-09-25"}; //{'S','I','0','2','.','0','6',':','1','1','0','3','1','6'};
