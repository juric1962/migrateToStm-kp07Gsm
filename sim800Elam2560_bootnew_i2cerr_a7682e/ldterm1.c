...
#ifdef VERS_BASE
__flash char ozu_vers[]  =   {'R','M','0','1','.','0','1',':','1','9','1','1','0','7'};
#endif

#ifdef VERS_LUFKIN
__flash char ozu_vers[]  =   {'R','M','0','2','.','0','1',':','1','9','1','1','0','7'};
#endif

#ifdef VERS_UNKNOWN
__flash char ozu_vers[]  =   {'R','M','0','0','.','0','1',':','1','9','1','1','0','7'};
#endif
...
extern __no_init unsigned char simka; //dobavka
...
unsigned char buf_boot_ver[10];
void read_boot_ver(void);
...
__flash char zp_apn1[] = {'4','.','A','P','N',' ','S','I','M','1',':',' '};
__flash char zp_apn2[] = {'5','.','A','P','N',' ','S','I','M','2',':',' '};
__flash char zp_ip[] = {'6','.','I','P',' ','a','d','d','r','e','s','s',' ','L','S',':',' '};

__flash char zp_db1[] = {'2','2','.','D','B',' ','A','P','N',':','1','.',' '};
__flash char zp_db2[] = {'2','3','.','D','B',' ','A','P','N',':','2','.',' '};
__flash char zp_db3[] = {'2','4','.','D','B',' ','A','P','N',':','3','.',' '};
...
__flash char map_vers[]  =   {'F','M','0','2','.','0','1',':','1','9','1','1','0','7'};
__flash char map_test_mtc[]  =   {'T','E','C','T','.','M','T','C',' ','M','O','D','U','L'};

__flash  char str_loop_ok[]= {"LOOP 485_1"};
__flash  char str_loop2_ok[]= {"LOOP 485_2"};
__flash char versia[] = {"M2560 A7682E 02-09-25"};                         //{'S','I','0','2','.','0','6',':','1','1','0','3','1','6'};

//__flash char zp_udp[]=        {'U','D','P','p','o','r','t','-','>'};
__flash char zp_udp[]=        {'7','.','U','D','P',' ','p','o','r','t',' ','L','S',':',' '};

//__flash char zp_num[]=        {'N','u','m','-','>'};
__flash char zp_num[]=        {'8','.','U','n','i','t',' ','n','u','m','b','e','r',':',' '};

__flash char init_sim900[]=        {'I','N','I','T','_','S','I','M','x','0','0',' ','O','K','!'};
...
__flash char zp_nat[]=        {'9','.','T','i','m','e',' ','s','e','s','s','i','o','n',' ','S','I','M','1',',','s',':',' '};
__flash char zp_nat_r[]=      {'1','0','.','T','i','m','e',' ','s','e','s','s','i','o','n',' ','S','I','M','2',',','s',':',' '};



//__flash char zp_link[]=       {'T','m',' ','c','c','h','-','>'};
__flash char zp_link[]=       {'1','1','.','T','i','m','e',' ','c','o','n','t','r','o','l',' ','c','h','a','n','n','e','l',',','s',':',' '};

//__flash char zp_tm_link[]=    {'T','m',' ','a','n','s','-','>'};
__flash char zp_tm_link[]=     {'1','2','.','T','i','m','e',' ','r','e','s','p','o','n','s','e',',','s',':',' '};


//__flash char zp_tm_no_link[]= {'T','m',' ','d','c','n','-','>'};        //!!!!!!!!!!!!!!!!dobavka
__flash char zp_tm_no_link[]=   {'1','3','.','T','i','m','e',' ','n','o',' ','l','i','n','k',',','m','i','n',':',' '};

//__flash char zp_tm_link_res[]={'T','m',' ','r','e','s','-','>'};    //!!!!!!!!!!!!!!!!dobavka
__flash char zp_tm_link_res[]=  {'1','4','.','T','i','m','e',' ','r','e','s','e','r','v','e',' ','S','I','M','2',',','m','i','n',':',' '};


//__flash char zp_tm_vz[]=      {'T','m',' ','t','a','k','e','-','>'};
__flash char zp_tm_vz[]=        {'1','7','.','T','i','m','e',' ','t','a','k','i','n','g',',','s',':',' '};

//__flash char zp_tm_cl[]=      {'T','m',' ','c','l','-','>'};
__flash char zp_tm_cl[]=      {'1','8','.','T','i','m','e',' ','c','o','n','t','r','o','l',' ','c','l','i','e','n','t',',','s',':',' '};

//__flash char zp_num_seq[]=    {'C','l',' ','m','s','q','-','>'};
__flash char zp_num_seq[]=     {'1','6','.','C','l','i','e','n','t',' ','n','u','m','b','e','r',':',' '};   


//__flash char zp_des_seq[]=    {'D','e','s',' ','m','s','g','-','>'};
__flash char zp_des_seq[]=     {'1','5','.','D','e','s','.',' ','m','e','s','s','a','g','e',':',' '}; 


//__flash char zp_type_tc1[]={'T','y','p','e',' ','T','S','1','-','>'};
//__flash char zp_type_tc2[]={'T','y','p','e',' ','T','S','2','-','>'};
__flash char zp_type_tc1[]={'1','9','.','T','y','p','e',' ','T','S','1',':',' '};
__flash char zp_type_tc2[]={'2','0','.','T','y','p','e',' ','T','S','2',':',' '};

//__flash char zp_dbg[]=        {'D','B','G','-','>'};
__flash char zp_dbg[]=        {'2','1','.','U','n','i','t',' ','r','e','g','i','m','e',':',' '};
...
//__flash char zp_temp[]= {'2','6','.','A','D',' ','c','o','n','v','e','r','t','e','r',':',' '}; 
__flash char zp_temp[]= {'2','6','.','T','e','m','p','e','r','a','t','u','r','e',':',' '};

//__flash char zp_vosst[]=      {'S','e','t',' ','d','e','f','-','>'};
__flash char zp_vosst[]=      {'2','7','.','S','e','t',' ','d','e','f','a','u','l','t',':',' '};
...
__flash char zp_log_file[]=   {'3','0','.','L','o','g',' ','f','i','l','e',':',' '};

//__flash char zp_keys[]=       {'K','e','y',' ','d','e','f','-','>'};
__flash char zp_keys[]=       {'3','1','.','K','e','y',' ','d','e','f',':',' '};


//__flash char zp_pinsim1[]=       {'P','I','N',' ','S','I','M','1','-','>'};
//__flash char zp_pinsim2[]=       {'P','I','N',' ','S','I','M','2','-','>'};

__flash char zp_pinsim1[]=       {'3','2','.','P','I','N',' ','S','I','M','1','-','>'};
__flash char zp_pinsim2[]=       {'3','3','.','P','I','N',' ','S','I','M','2','-','>'};

__flash char zp_traffic[]=      {'3','4','.','T','r','a','f','f','i','c',' ',' ','O','U','T',':','I','N',' ','-','>',' '};


__flash unsigned char keys_def[]={'s','m','a','r','t','p','l','u'};


__flash unsigned char def_apn[] = {'i','n','t','e','r','n','e','t','.','m','t','s','.','r','u',0x00};
__flash unsigned char def_usname[] = {0x00};   
__flash unsigned char def_uspsw[] = {0x00}; 

__flash unsigned char def_apnr[] = {'i','n','t','e','r','n','e','t','.','b','e','e','l','i','n','e','.','r','u',0x00};
...
__flash unsigned char def_apn1[] = {'i','n','t','e','r','n','e','t','.','m','t','s','.','r','u',0x00};
__flash unsigned char def_usname1[] = {0x00};   
__flash unsigned char def_uspsw1[] = {0x00}; 

__flash unsigned char def_apn2[] = {'i','n','t','e','r','n','e','t','.','b','e','e','l','i','n','e','.','r','u',0x00};
...
__flash unsigned char def_apn3[] = {'i','n','t','e','r','n','e','t',0x00};
...
//__flash char zp_ts_dop_mtc[]= {'2','.','T','S',',':'};


unsigned char keys[10];

extern unsigned int crc_m1(unsigned char *ka,unsigned int num,unsigned int crc);
...
unsigned char ret_version(unsigned char unit,unsigned char *ptr)
{
 ...
 if(unit==2)
  ...
  /*
    ...
    */  
      ...
      for (i=0;i<emei_emei[0];i++){*ptr=emei_emei[i+1];ptr++;}  // высвечивает emei симкки
      *ptr=0;
 ...
 if(unit==0)
    {
    for (i=0;i<sizeof(versia)-1;i++){*ptr=versia[i];ptr++;}
    
    /*
    read_boot_ver();
    for (i=0;i<7;i++){*ptr=buf_boot_ver[i];ptr++;}
    */
 ...
 // map
    else
    {
      ...
      *ptr++='=';
      */
      for (i=0;i<csq[0];i++){*ptr=csq[i+1];ptr++;}  // высвечивает emei симкки
...
//загрузка поумолчанию
     ...
     buf[0]=temp;
     j=1;
     for(i=0;i<temp;i++){buf[j]=def_apn[i];j++;}
     
     temp=sizeof(def_usname)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_usname[i];j++;} 
     
     temp=sizeof(def_uspsw)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_uspsw[i];j++;}
     
     for(i=0;i<L_C_GPRS_MAX;i++){buf[j]=0;j++;}
     *(unsigned int*)&buf[L_C_GPRS_MAX-2]=crc_m1(&buf[0],L_C_GPRS_MAX-2,0xffff);
     ...
     buf[0]=temp;
     j=1;
     for(i=0;i<temp;i++){buf[j]=def_apnr[i];j++;}
     
     temp=sizeof(def_usnamer)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_usnamer[i];j++;} 
     
     temp=sizeof(def_uspswr)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_uspswr[i];j++;}
     
     for(i=0;i<L_CR_GPRS_MAX;i++){buf[j]=0;j++;}
     *(unsigned int*)&buf[L_CR_GPRS_MAX-2]=crc_m1(&buf[0],L_CR_GPRS_MAX-2,0xffff);
   ...
   *(unsigned int*)&buf[OFS_PORT]=DEF_UDP_PORT;//UDP порт
   //*(unsigned int*)&buf[OFS_NUM]=*(unsigned int*)&buf[0];          //свой номер не менять !!!! 
 ...
 */
   ...
   buf[OFS_PIN_SIM1+2]='.';
   buf[OFS_PIN_SIM1+3]='.';
   *(unsigned int*)&buf[OFS_KOD_SIM1_CRC]=crc_m1(&buf[0],L_KOD_SIM1-2,0xffff);
   ...
   buf[OFS_PIN_SIM2+2]='.';
   buf[OFS_PIN_SIM2+3]='.';
   *(unsigned int*)&buf[OFS_KOD_SIM2_CRC]=crc_m1(&buf[0],L_KOD_SIM2-2,0xffff);
     ...
     buf[0]=temp;
     j=1;
     for(i=0;i<temp;i++){buf[j]=def_apn1[i];j++;}
    
     temp=sizeof(def_usname1)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_usname1[i];j++;} 
    
     temp=sizeof(def_uspsw1)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_uspsw1[i];j++;}
    
     for(i=0;i<L_C1_GPRS_MAX;i++){buf[j]=0;j++;}
     *(unsigned int*)&buf[L_C1_GPRS_MAX-2]=crc_m1(&buf[0],L_C1_GPRS_MAX-2,0xffff);
     ...
     buf[0]=temp;
     j=1;
     for(i=0;i<temp;i++){buf[j]=def_apn2[i];j++;}
     
     temp=sizeof(def_usname2)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_usname2[i];j++;} 
     
     temp=sizeof(def_uspsw2)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_uspsw2[i];j++;}
     
     for(i=0;i<L_C2_GPRS_MAX;i++){buf[j]=0;j++;}
     *(unsigned int*)&buf[L_C2_GPRS_MAX-2]=crc_m1(&buf[0],L_C2_GPRS_MAX-2,0xffff);
     ...
     buf[0]=temp;
     j=1;
     for(i=0;i<temp;i++){buf[j]=def_apn3[i];j++;}
     
     temp=sizeof(def_usname3)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_usname3[i];j++;} 
     
     temp=sizeof(def_uspsw3)-1;
     buf[j]=temp;
     j++;
     for(i=0;i<temp;i++){buf[j]=def_uspsw3[i];j++;}
     
     for(i=0;i<L_C3_GPRS_MAX;i++){buf[j]=0;j++;}
     *(unsigned int*)&buf[L_C3_GPRS_MAX-2]=crc_m1(&buf[0],L_C3_GPRS_MAX-2,0xffff);
...
if(*(unsigned int*)&buf[j]!=crc_m1(&buf[0],j,0xffff))return(1);
for(i=0;i<j;i++)if(buf[i]==map_vers[i])continue;else return(1);


 
  
RdFromFleshToArr(A_C_GPRS,&buf[0],L_C_GPRS_MAX);
if(*(unsigned int*)&buf[L_C_GPRS_MAX-2]!=crc_m1(&buf[0],L_C_GPRS_MAX-2,0xffff))
    {
...
if(*(unsigned int*)&buf[L_CR_GPRS_MAX-2]!=crc_m1(&buf[0],L_CR_GPRS_MAX-2,0xffff))
    {
...
if(*(unsigned int*)&buf[OFS_KOD_SIM1_CRC]!=crc_m1(&buf[0],L_KOD_SIM1-2,0xffff))
  {
   buf[OFS_PIN_SIM1]='.';
   buf[OFS_PIN_SIM1+1]='.';
   buf[OFS_PIN_SIM1+2]='.';
...
if(*(unsigned int*)&buf[OFS_KOD_SIM2_CRC]!=crc_m1(&buf[0],L_KOD_SIM2-2,0xffff))
  {
   buf[OFS_PIN_SIM2]='.';
   buf[OFS_PIN_SIM2+1]='.';
   buf[OFS_PIN_SIM2+2]='.';
...
if(*(unsigned int*)&buf[L_C1_GPRS_MAX-2]!=crc_m1(&buf[0],L_C1_GPRS_MAX-2,0xffff))
    {
...
if(*(unsigned int*)&buf[L_C2_GPRS_MAX-2]!=crc_m1(&buf[0],L_C2_GPRS_MAX-2,0xffff))
    {
...
if(*(unsigned int*)&buf[L_C3_GPRS_MAX-2]!=crc_m1(&buf[0],L_C3_GPRS_MAX-2,0xffff))
    {
...
if(*(unsigned int*)&keys[L_KEYS-2]!=crc_m1(&keys[0],L_KEYS-2,0xffff))return(1);
return(0);
}
...
///работа с терминаломработа с терминаломработа с терминаломработа с терминаломабота с терминаломработа с терминаломработа с терминаломработа с терминалом
...
void    mov_massiv (char size, char *p)
 ...
 void read_menu(unsigned char index_menu)
   ...
   memset(massiv,0,13); 
    ...
    if( index_menu    ==25) SET_TEN;
    if( index_menu    !=25)CLR_TEN;                                 // для проверки нагревателя в этом пункте он включается
     ...
     switch (index_menu) 
        ...
        case 1: 
               ...
               s_port('2');
               s_port('.');
               mov_s ( sizeof(map_test_mtc),map_test_mtc);                              
               mov_lf(); 
               s_port('>');  
               break;  
#else   
...
povt_1:            
               ...
               if((buf[0]!=0)&&(buf[0]<31))
               {
                ...
                i=0;
                k=0;
                while(i<buf[k]){s_port(buf[k+1+i]);i++;}   
                s_port('"');
     ...
     case 18:  RdFromFleshToArr(A_TP_TS,&buf[0],1);
               mov_lf();        
    ...
    case 19:  RdFromFleshToArr(A_TP_TS+1,&buf[0],1);
               mov_lf();        
    ...
    case 20: 
     ...
     case 24:
                ...
                if(struct_tcc1.tek_pin==1)s_port('0');else s_port('1');
                if(struct_tcc2.tek_pin==1)s_port('0');else s_port('1'); 
  ...
  case 30:  
         ...
         //   s_port('>');  
            ...
            for(i=0;i<8;i++)buf[20+i]=keys_def[i];
 ...
 case 34:
                ...
                for(i=0;i<8;i++)if ((modbus_mem1[AD_TS]>>i)&0x01)s_port('1');else s_port('0');
                mov_lf();
                s_port('>');  
                break; 
 ...
 case 36:      
            ...
            if(PORTA & IO11)s_port('1');else s_port('0');
            if(PORTA & IO12)s_port('1');else s_port('0');
            mov_lf(); 
            s_port('>');     
            break; 
...
case 38: 
 ...
 case 39:     
  ...
  void write_menu(unsigned char index_menu)
   ...
   case 1:    
          ...
          return;
                 ...
                 case 3: 
                        if(vol_tx_ppp!=2)goto bad_com_232;
                      ...
                      switch(buf_tx_232[0])
                         
                           {
                            case '1':
                                  RdFromFleshToArr(A_C1_GPRS,&buf[0],L_C1_GPRS_MAX);
                                  if((buf[0]==0)||(buf[0]>30))goto bad_com_232;
                                 break;
                            case '2':
                                 RdFromFleshToArr(A_C2_GPRS,&buf[0],L_C2_GPRS_MAX);
                                 if((buf[0]==0)||(buf[0]>30))goto bad_com_232;
                ...
                case 4: 
                 ...
                 case 5:
                         if(vol_tx_ppp!=16)goto bad_com_232;
                         if(buf_tx_232[3]!='.')goto bad_com_232;
                         if(buf_tx_232[7]!='.')goto bad_com_232;
                         if(buf_tx_232[11]!='.')goto bad_com_232;
                         
                         RdFromFleshToArr(A_IP_PAR,&buf[0],L_IP_PAR); 
 
                         
                         cifra_long.word=atol((char *)&buf_tx_232[0]); 
                         if(cifra_long.word>255)goto bad_com_232;
                            else buf[OFS_IP]=cifra_long.bytes[0];
       
                         cifra_long.word=atol((char *)&buf_tx_232[4]);  
                         if(cifra_long.word>255)goto bad_com_232;
                            else buf[OFS_IP+1]=cifra_long.bytes[0];
                         
                         cifra_long.word=atol((char *)&buf_tx_232[8]); 
                          if(cifra_long.word>255)goto bad_com_232;
                              else buf[OFS_IP+2]=cifra_long.bytes[0];
                         
                            
                         cifra_long.word=atol((char *)&buf_tx_232[12]); 
                          if(cifra_long.word>255)goto bad_com_232;
                              else buf[OFS_IP+3]=cifra_long.bytes[0];
                 ...
                 case 6:
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word>65535) goto bad_com_232;
                 ...
                 case 7:
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word<3)goto bad_com_232;
                      if (cifra_long.word>65535) goto bad_com_232;
                      for (i=0;i<12;i++) 
                      {
                        if ( (buf_tx_232[i]==0xd))  {
                                 if (  ( buf_tx_232[i-1]== '*' )  && ( buf_tx_232[i-2]== '*' )  && ( buf_tx_232[i-3]== '*' ) ) goto enable_wri; 
                                   vol_tx_ppp=0;                                                                                      
        ...
        enable_wri:      
                 ...
                 case 8:
                      ...
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word<10)goto bad_com_232;
                      if (cifra_long.word>65535) goto bad_com_232;
               ...
               case 9:
                ...
                case 11:
                      ...
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word<5)goto bad_com_232;
                      if (cifra_long.word>65535) goto bad_com_232;
     ...
     //!!!!!!!!!!! dobavka        
               case 12:
                      ...
                      if((cifra_long.word *60) <= (*(unsigned int*)&buf[OFS_CCH]))goto bad_com_232;
              ...
              case 13:
                      ...
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word<MIN_TM_LINK_RES) goto bad_com_232;
                      if (cifra_long.word>65535) goto bad_com_232;
             ...
             //EEEEEEEEEEEEEEEEE dobavka                           
              ...
              case 14: 
                         if(vol_tx_ppp!=2)goto bad_com_232;
                         if((buf_tx_232[0]=='0')||(buf_tx_232[0]=='1'))cifra_long.bytes[0]=buf_tx_232[0]-0x30;
                            else goto bad_com_232;
                ...
                case 16:
                      ...
                      cifra_long.word=atol((char *)&buf_tx_232[0]);                                                                                      
                      if (cifra_long.word==0)goto bad_com_232;
                      if (cifra_long.word>65535) goto bad_com_232;
               ...
               case 20: 
                         cifra_long.word=atol((char *)&buf_tx_232[0]);
                          if (cifra_long.word>3)goto bad_com_232;   //dobavka 
               ...
               case 21:
                     if((vol_tx_ppp<7)||(vol_tx_ppp>60))goto bad_com_232;
                     
                     if(buf_tx_232[0]!='"')goto bad_com_232;
                     if(buf_tx_232[vol_tx_ppp-2]!='"')goto bad_com_232;
                     ...
                     n=i;
                     m=j;
                     while(buf_tx_232[j]!='"'){j++;i++;}
                     if (j>=vol_tx_ppp-2)goto bad_com_232;
                     j++;
                     if (buf_tx_232[j]!='"')goto bad_com_232;
                     if (j>=vol_tx_ppp-1)goto bad_com_232;
                     buf[n]=i;
                     for(k=0;k<buf[n];k++)buf[n+1+k]=buf_tx_232[m+k];
    ...
    case 26: 
                         if(vol_tx_ppp!=2)goto bad_com_232;
                         if(buf_tx_232[0]!='1')goto bad_com_232;
                      ...
                      return;    
   case 27:
              if(vol_tx_ppp!=9)goto bad_com_232; 
              if((buf_tx_232[2]!=':')&&(buf_tx_232[2]!='.'))goto bad_com_232;
              if((buf_tx_232[5]!=':')&&(buf_tx_232[5]!='.'))goto bad_com_232;
             ...
             buf[5]=real_time.r_year;
              ...
              if(cifra_long.word>59)goto bad_com_232;
              else buf[0]=cifra_long.bytes[0];
              
     
              cifra_long.word=atol((char *)&buf_tx_232[3]); 
              if(cifra_long.word>59)goto bad_com_232;
              else buf[1]=cifra_long.bytes[0];
       
              cifra_long.word=atol((char *)&buf_tx_232[0]); 
              if(cifra_long.word>23)goto bad_com_232;
              else buf[2]=cifra_long.bytes[0];
   ...
   case 28:
              if(vol_tx_ppp!=9)goto bad_com_232; 
              if(buf_tx_232[2]!='.')goto bad_com_232;
              if(buf_tx_232[5]!='.')goto bad_com_232;
             ...
             buf[2]=real_time.r_hor;
              ...
              cifra_long.word=atol(( char *)&buf_tx_232[0]); 
              if(cifra_long.word==0)goto bad_com_232;
              if(cifra_long.word>31)goto bad_com_232;
              else buf[3]=cifra_long.bytes[0];
              
     
              cifra_long.word=atol((char *)&buf_tx_232[3]); 
              if(cifra_long.word==0)goto bad_com_232;
              if(cifra_long.word>12)goto bad_com_232;
              else buf[4]=cifra_long.bytes[0];
   ...
   case 29: 
                         ...
                         if(vol_tx_ppp!=4)goto bad_com_232;
                         if(buf_tx_232[0]!='l')goto bad_com_232;
                         if(buf_tx_232[1]!='o')goto bad_com_232;
                         if(buf_tx_232[2]!='g')goto bad_com_232;
                         
                         RdFromFleshToArr(BEG_BUF_LOG,&buf_tx_232[0],(L_LOG*6));                      
                         
                         s_port(0xd);
                         s_port(0xa);
                         for(jj=0;jj<(L_LOG*6);jj++) s_port(buf_tx_232[jj]);
                         vol_tx_ppp=0; 
                         mov_s ( sizeof(ok_t),ok_t);  
                         return;       
  ...
  case 31:            if(vol_tx_ppp!=5)goto bad_com_232;
                      if((buf_tx_232[0]!='.') &&((buf_tx_232[0]<0x30)||(buf_tx_232[0]>0x39)))goto bad_com_232;
                      if((buf_tx_232[1]!='.') &&((buf_tx_232[1]<0x30)||(buf_tx_232[1]>0x39)))goto bad_com_232;
                      if((buf_tx_232[2]!='.') &&((buf_tx_232[2]<0x30)||(buf_tx_232[2]>0x39)))goto bad_com_232;
                      if((buf_tx_232[3]!='.') &&((buf_tx_232[3]<0x30)||(buf_tx_232[3]>0x39)))goto bad_com_232;
 ...
 case 32:            if(vol_tx_ppp!=5)goto bad_com_232;
                      if((buf_tx_232[0]!='.') &&((buf_tx_232[0]<0x30)||(buf_tx_232[0]>0x39)))goto bad_com_232;
                      if((buf_tx_232[1]!='.') &&((buf_tx_232[1]<0x30)||(buf_tx_232[1]>0x39)))goto bad_com_232;
                      if((buf_tx_232[2]!='.') &&((buf_tx_232[2]<0x30)||(buf_tx_232[2]>0x39)))goto bad_com_232;
                      if((buf_tx_232[3]!='.') &&((buf_tx_232[3]<0x30)||(buf_tx_232[3]>0x39)))goto bad_com_232;
 ...
 case 33: 
                         if(vol_tx_ppp!=2)goto bad_com_232;
                         if(buf_tx_232[0]!='0')goto bad_com_232;                    

                         *(unsigned long int*)&buf[0]=burst_ds_r();
                         for(i=4;i<12;i++)buf[i]=0;
                         *(unsigned int*)&buf[L_TRAF-2]=crc_m1(&buf[0],L_TRAF-2,0xffff);
                         WrArrayToFlesh(A_TRAF, &buf[0],L_TRAF,0,0); 
                         vol_tx_ppp=0; 
                         mov_s ( sizeof(ok_t),ok_t); 
 ...
 case 36: 
                         ...
                         if(vol_tx_ppp!=3)goto bad_com_232;
                         if((buf_tx_232[0]!='0')&& (buf_tx_232[0]!='1')&&(buf_tx_232[0]!='i'))goto bad_com_232;
                         if((buf_tx_232[1]!='0')&&(buf_tx_232[1]!='1')&&(buf_tx_232[1]!='i'))goto bad_com_232;
                         
                         if(buf_tx_232[0]=='0') {TU1_OFF;} else {TU1_ON; if(buf_tx_232[0]=='i')cnt_tu1=TM_TU_IMP;}
                         if(buf_tx_232[1]=='0') {TU2_OFF;} else {TU2_ON; if(buf_tx_232[1]=='i')cnt_tu2=TM_TU_IMP;} 
                         vol_tx_ppp=0; 
                         mov_s ( sizeof(ok_t),ok_t);
                         return;                              
  case 37: 
 ...
 case 38: 
                         if(vol_tx_ppp!=2)goto bad_com_232;
                         if((buf_tx_232[0]=='0')||(buf_tx_232[0]=='1'))buf_tx_232[0]=buf_tx_232[0]-0x30;
                            else goto bad_com_232;
 ...
 case 39:                {
   ...
   void at_mon_232(void)
    { 
     ...
     // * в фоновом режиме выводим все что пришло с сим модуля
       if ( (UCSR2A & 0x20) ==0) goto no_Ready_com2;
    ...
    no_Ready_com2:                                      
      ...
      for (i = 0; i < vol_tx_ppp - 1; i++) {
       if( buf_tx_232[i] == 0x54  && buf_tx_232[i] == 0x2b
  ...
  if ( (local >= 3 )  && (buf_tx_232[local-1]==0x2b) && ((buf_tx_232[local-2]=='T') || (buf_tx_232[local-2]=='t')) ) return;   // at+ пропустить
...
#endif  
  // тут будет сценарий проверки ТС платы расширения
  if ( local == 0 ) return;   /// заплатка от 23 06 22
 //************************    
...
pusto:            
                   ...
                   index_pa++;  
                   if ((index_pa-1) > VOL_PUNKT) index_pa=1;
                   read_menu(index_pa-1);                                    
                   buf_tx_232[local-1]=0xff;  
                   vol_tx_ppp=0; 
                   UCSR0B=UCSR0B | 0x90; 
         ...
         case 0x2d:   // вниз
           ...
           case 0x0d:   // ввод
                  {  
                   ...
                   UCSR0B=UCSR0B & ~0x90;  
                   if(index_pa==41) goto nene_pusto; 
                   if ((local==1)||(index_pa==0)) goto pusto; 
        nene_pusto:
...
// принимаю с 485_2
//
             if ( (UCSR3A & 0x80) ==0) goto LoopWait_rs485_1;
             s_port('r');
             dummy=UDR3;
             s_port(dummy + 0x30);
//     tutu:
...
// принимаю с 485_1
//
             if ( (UCSR1A & 0x80) ==0) goto LoopWait_rs485_1;
             s_port('r');
             dummy=UDR1;
             s_port(dummy + 0x30);
//     tutu:
...
void scenario_test_mtc(void)
{
  char massiv[13];
  char i;
if( test_mtc.enable ==0) return;
switch( test_mtc.step)
{
...
case 1:
                  ...
                  if(test_mtc.delay) {test_mtc.delay --;break;}
                   else 
                       test_mtc.step = 2;
                  break;
...
case 2:
                mov_lf();
                mov_s ( sizeof(zp_ts_dop) - 3,zp_ts_dop + 3);           
                for(i=0;i<8;i++)if ((modbus_mem1[AD_TS]>>i)&0x01)s_port('1');else s_port('0');
                if( modbus_mem1[AD_TS] == 0x0) { s_port(' ');s_port('O'); s_port('K'); }
                mov_lf();
                s_port('>'); 
...
case 4:
                ...
                mov_s ( sizeof(zp_ts_dop) - 3,zp_ts_dop + 3);            
                for(i=0;i<8;i++)if ((modbus_mem1[AD_TS]>>i)&0x01)s_port('1');else s_port('0');
               if( modbus_mem1[AD_TS] == 0xa5) {s_port(' '); s_port('O'); s_port('K'); }
                mov_lf();
                s_port('>'); 
...
case 6:
                ...
                mov_s ( sizeof(zp_ts_dop) - 3,zp_ts_dop + 3);            
                for(i=0;i<8;i++)if ((modbus_mem1[AD_TS]>>i)&0x01)s_port('1');else s_port('0');
                if( modbus_mem1[AD_TS] == 0x52) { s_port(' ');s_port('O'); s_port('K'); }
                mov_lf();
                s_port('>'); 
...
case 8:
                ...
                mov_s ( sizeof(zp_ts_dop) - 3,zp_ts_dop + 3);           
                for(i=0;i<8;i++)if ((modbus_mem1[AD_TS]>>i)&0x01)s_port('1');else s_port('0');
                if( modbus_mem1[AD_TS] == 0xf7) {s_port(' '); s_port('O'); s_port('K'); }
                mov_lf();
                s_port('>'); 
                ...
                mov_lf();
                mov_s ( sizeof(zp_tit) - 3,zp_tit + 3);     
                sprintf(massiv,"%u\0",modbus_mem1[AD_TIT1]);
                mov_massiv(strlen(massiv),massiv);
                s_port(' ');
                sprintf(massiv,"%u\0",modbus_mem1[AD_TIT2]);
