...
extern void WrArrayToFlesh(unsigned int adres_flesh,  unsigned char *adres_ozu, unsigned int num,unsigned char flag,unsigned char znach);  //запись конфигурации кп во флеш
...
void tx_rs485_1(void)
{
  unsigned int i;
    ...
    for(i=0;i<Rs485_1.cnt_bt_rx_tx;i++)Rs485_1_buf_rx_tx[i]=i;
...
void tx_rs485_2(void)
{
  unsigned int i;
    ...
    for(i=0;i<Rs485_2.cnt_bt_rx_tx;i++)Rs485_2_buf_rx_tx[i]=i;
...
void tx_rs232_2(void)
{
  unsigned int i;
    ...
    for(i=0;i<Rs232_2.cnt_bt_rx_tx;i++)Rs232_2_buf_rx_tx[i]=i;
