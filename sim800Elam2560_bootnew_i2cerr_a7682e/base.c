...
enum t_state_modem {STM_NONE=0,STM_ON,STM_KON,STM_PWK,STM_SI,STM_SC,STM_SCP,STM_PPP,STM_RDC,STM_DC,STM_OFF};
            ...
            switch(state_modem)
               ...
               case STM_SCP:
                  ...
                  case STM_PPP:
                              ...
                              if(((PINE & DCD0)==0) || (Fl_ch_sim==1))  //dobavka
                              {
                              ...
                              //  st_gprs_att(); !!!!!!!!!!!!!!!!!!!!!11
                                ...
                                clr_var_ppp_rx();//обнулить все что касается приему по GPRS и запретить прием
                                command_AT=FALSE;// выключен коммандный режим
                                //event_modem=EVM_RDC; //21.01.2008
                                event_modem=EVM_NONE;
                               }
                              }
...
void monitor1_rec_rs232_2(void)
 ...
 // __enable_interrupt();
  ...
  if(fl_232_2.over==1)
    ...
    //!!!!!!!!!!!!!! здесь бы надо проверк на длину буфера для PPP
   if(Rs232_2.cnt_bt_rx_tx+100>VOL_TX_PPP)
      {
