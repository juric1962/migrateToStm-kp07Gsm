...
#ifdef VERS_BASE
__flash char ozu_vers[]  =   {'O','K','0','1','.','0','1',':','1','4','0','5','0','7'};
#endif

#ifdef VERS_LUFKIN
__flash char ozu_vers[]  =   {'O','K','0','2','.','0','1',':','1','4','0','5','0','7'};
#endif

#ifdef VERS_UNKNOWN
__flash char ozu_vers[]  =   {'O','K','0','0','.','0','1',':','1','4','0','5','0','7'};
#endif
...
__flash char map_vers[]  =   {'F','K','0','2','.','0','1',':','2','7','0','9','0','7'};
__flash char versia[] = {'V','K','0','2','.','0','1',':','1','4','1','1','0','7'};
...
unsigned char ret_version(unsigned char unit,unsigned char *ptr)
{
 ...
 if(unit==0)
    ...
    *ptr=0;
    ...
    {
    for (i=0;i<sizeof(versia);i++){*ptr=map_vers[i];ptr++;}
    *ptr=0;
...
if (e_first_on==0xff)
 ...
 if(e_debug>3)e_debug=RG_WORK; //dobavka
 Regim=e_debug;
}
