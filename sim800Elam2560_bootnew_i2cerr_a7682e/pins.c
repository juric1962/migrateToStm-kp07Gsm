  ...
  while (1) {
    ...
    case 2: {
      ...
      if (UCSR0A & 0x80) {
        ...
        if (str_cmp1[0] == 'A' && str_cmp1[1] == 'T' && str_cmp1[2] == 'I' &&
            str_cmp1[3] == 'F' && str_cmp1[4] == 'C' &&
            //   str_cmp1[5]=='D'  &&
            str_cmp1[6] == '=' && str_cmp1[7] <= 0x33 && str_cmp1[7] >= 0x30 &&
            str_cmp1[8] == ',' && str_cmp1[9] <= 0x33 && str_cmp1[9] >= 0x30 &&
            str_cmp1[10] == ',' && str_cmp1[11] <= 0x32 &&
            str_cmp1[11] >= 0x30) {
